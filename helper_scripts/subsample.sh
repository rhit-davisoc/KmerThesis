...
do
    ../../KMC3/kmc -t$cpus -k$km -ci$min_count $read_file_path"n"$i"_R1.fastq" $kmer_output/tmp/$test_name"/n"$i"_R1" .&&

    ../../KMC3/kmc -t$cpus -k$km -ci$min_count $read_file_path"n"$i"_R2.fastq" $kmer_output/tmp/$test_name"/n"$i"_R2" . &&
